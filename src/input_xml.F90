...
!===============================================================================
  ...
  subroutine read_tallies_xml()
    ...
    logical :: found         ! Nuclide was found in dictionary
    ...
    type(DictEntryCI), pointer :: pair_list
    ...
    type(DictEntryCI), pointer :: scores
      ...
      associate(deriv => tally_derivs(i))
        ...
        case("nuclide_density")
          ...
          do while (associated(pair_list))
            ...
            ! Advance to next and deallocate
            next => pair_list % next
          ...
          SCORE_LOOP: do j = 1, n_words
            ...
            if (score_name == "all") then
              ...
              do while (associated(scores))
                ...
                t % triggers(trig_ind) % score_name = trim(scores % key)
                t % triggers(trig_ind) % score_index = scores % value
